...
class ObjectSerializer
{
     ...
     * @param string $type   the UScreenType of the data
     * @param string $format the format of the UScreen type of the data
     *
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\UScreen\Client\Model\\' . $data->{$discriminator};
